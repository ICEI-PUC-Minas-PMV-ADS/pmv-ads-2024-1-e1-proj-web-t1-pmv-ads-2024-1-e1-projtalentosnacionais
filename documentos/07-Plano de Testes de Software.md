...
| CT-02: Verificar a usabilidade |RF-3: RF-12	A aplicação deve possuir um sistema que permite o usuario ter acesso as outras paginas do site.| Verificar se possui todos campos necessários para acessar as páginas| 1- Acessar a página 2- Clicar nos links para acessar as páginas| A página deve permitir os usuários acessar o link para as páginas|

## Página de Login

Responsável pelo teste - Gabryella 
...
|------------------------|---------------------------|--------------------|--------|--------------------|
| CT-01: Verificar a responsividade da página | RNF- 02 A aplicação deve permitir a visualização em diversos tipos de dispositivos.| Verificar se a página está responsiva em diversos formatos| 1- Acessar a página 2- abrir as ferramentas de desenvolvimento do navegador 3- alterar as dimensões da tela para os formatos | A página deve ser responsiva aos formatos de celurares, tablet e PC|
| CT-02: Verificar a usabilidade |RF-3: RF-07	A aplicação deve possuir links para redes sociais do profissional cadastrado.| Verificar se possui todos campos necessários para adicionar os links| 1- Acessar a página 2- Clicar nos links específicos 3- Adicionar os links| A página deve permitir o profissional adicionar links para suas redes sociais|
...
|------------------------|---------------------------|--------------------|--------|--------------------|
| CT-01: Verificar a responsividade da página | RNF- 02 A aplicação deve permitir a visualização em diversos tipos de dispositivos.| Verificar se a página está responsiva em diversos formatos| 1- Acessar a página  2- abrir as ferramentas de desenvolvimento do navegador 3- alterar as dimensões da tela para os formatos | A página deve ser responsiva aos formatos de celurares, tablet e PC|
| CT-02: Verificar a usabilidade        |RF-11: A aplicação deve possuir um sistema de cancelar conta, permitindo o usuário cancelar o seu perfil.| Verificar se o campo esta preenchido com a palvra "cancelar"  | 1- Acessar a página  2- Escrever "cancelar" no campo designado  3- Cancelar conta | os resultado permitir que o usuario cancele a conta |


## Página Princial/ Menu
...
|------------------------|---------------------------|--------------------|--------|--------------------|
| CT-01: Verificar a responsividade da página | RNF- 02 A aplicação deve permitir a visualização em diversos tipos de dispositivos.| Verificar se a página está responsiva em diversos formatos| 1- Acessar a página  2- abrir as ferramentas de desenvolvimento do navegador 3- alterar as dimensões da tela para os formatos | A página deve ser responsiva aos formatos de celurares, tablet e PC|
| CT-02: Verificar a usabilidade        |RF-12: A aplicação deve possuir um sistema que permite o usuario ter acesso as outras paginas do site.| Verificar os botões estão funcionado  | 1- Acessar a página  2- acessar um botão e ir para a pagina correta  3- buscar palavra chave | os resultado permitir que o usuario tenha acesso a pagina "criar perfil", "vizualizar curriculo", "cadastrar redes sociais", "sobre nós" e "cancelar conta" |
